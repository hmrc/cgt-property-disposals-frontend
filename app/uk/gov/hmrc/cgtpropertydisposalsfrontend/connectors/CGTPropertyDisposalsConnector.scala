...
import uk.gov.hmrc.cgtpropertydisposalsfrontend.models.{Error, RegistrationDetails, SubscribedAndVerifierDetails, SubscribedDetails, SubscriptionDetails}
...
class CGTPropertyDisposalsConnectorImpl @Inject()(http: HttpClient, servicesConfig: ServicesConfig)(
  ...
  override def updateSubscribedDetails(subscribedAndVerifierDetails: SubscribedAndVerifierDetails)(
    ...
    makeCall(_.put(subscriptionUpdateUrl, subscribedAndVerifierDetails))
