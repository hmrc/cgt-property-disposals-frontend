...
import uk.gov.hmrc.cgtpropertydisposalsfrontend.models.onboarding.JourneyStatus._
import uk.gov.hmrc.cgtpropertydisposalsfrontend.models.onboarding.SubscriptionDetails.MissingData
import uk.gov.hmrc.cgtpropertydisposalsfrontend.models.onboarding.UserType.{Individual, NonGovernmentGatewayUser, Trust}
...
import uk.gov.hmrc.cgtpropertydisposalsfrontend.models.onboarding.{NeedMoreDetailsDetails, SubscriptionDetails, UserType}
...
class StartController @Inject()(
  ...
  def start(): Action[AnyContent] = authenticatedActionWithRetrievedDataAndSessionData.async { implicit request =>
    (
      ...
      case (_, Some(_: Subscribed)) =>
        Redirect(uk.gov.hmrc.cgtpropertydisposalsfrontend.controllers.routes.HomeController.homepage())
  ...
  private def handleSubscribedUser(cgtReference: CgtReference, ggCredId: GGCredId)(
    ...
    result.fold(
      ...
      _ => Redirect(uk.gov.hmrc.cgtpropertydisposalsfrontend.controllers.routes.HomeController.homepage())
    )
  }
    ...
    updateSession(sessionStore, request)(
      _.copy(
        ...
        needMoreDetailsDetails = Some(
          onboarding.NeedMoreDetailsDetails(
