...
wereYouAUKResident.capacitor.title=Was the person a UK resident on the day contracts were exchanged?
wereYouAUKResident.personalRep.title=Was the person a UK resident on the contract exchange date?
...
enterPostcode.returns.personalRepInPeriodOfAdmin.agent.singleDisposal.title=Find the address of the UK property the person disposed of
...
address-select.returns.personalRepInPeriodOfAdmin.agent.singleDisposal.title=Select the address of the UK property the person disposed of
...
address.uk.returns.personalRepInPeriodOfAdmin.agent.singleDisposal.title=Enter the address of the UK property the person disposed of
...
disposalFees.personalRepInPeriodOfAdmin.agent.helpText=For example, the amount the estate paid to an estate agent or solicitor. If the costs were shared you can only include the estate’s share.
disposalFees.personalRepInPeriodOfAdmin.agent.indirect.helpText=For example, the amount the estate paid to an estate agent or solicitor. If the costs were shared you can only include the estate’s share.
