...
import uk.gov.hmrc.cgtpropertydisposalsfrontend.models.onboarding.JourneyStatus.SubscriptionStatus.{DeterminingIfOrganisationIsTrust, SubscriptionMissingData}
      ...
      "redirect to the 'register your trust' page" when {
        ...
        "the user does not have a TRN" in {
          ...
          checkIsRedirect(
            ...
            onboardingRoutes.DeterminingIfOrganisationIsTrustController.registerYourTrust()
          )
        }
      ...
      "display an error page" when {
        ...
        "redirect to the enter TRN and trust name page" when {
          ...
          "the user has attempted a name match but they still have attempts left" in {
            ...
            checkIsRedirect(performAction(), onboardingRoutes.DeterminingIfOrganisationIsTrustController.enterTrn())
          }
