...
import uk.gov.hmrc.cgtpropertydisposalsfrontend.models.onboarding.JourneyStatus.RegistrationStatus.IndividualSupplyingInformation
  ...
  "AddressController" when {
    ...
    "handling submitted postcodes and filters" must {
      ...
      behave like submitEnterPostcode(
        performAction,
        addressRoutes.RegistrationEnterAddressController.selectAddress()
      )
