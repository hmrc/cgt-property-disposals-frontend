  ...
  "IvController" when {
    ...
    "handling IV failure requests" must {
      ...
      "redirect to the IV error page" when {
        ...
        "there is an error querying the journey status" in {
          ...
          checkIsRedirect(performAction(), routes.IvController.getTechnicalIssue())
        }

      }

      List(
        IvErrorStatus.Incomplete           -> (() => routes.IvController.getTechnicalIssue()),
        IvErrorStatus.FailedMatching       -> (() => routes.IvController.getFailedMatching()),
        IvErrorStatus.FailedIV             -> (() => routes.IvController.getFailedIV()),
        IvErrorStatus.InsufficientEvidence -> (() => routes.IvController.getInsufficientEvidence()),
        IvErrorStatus.LockedOut            -> (() => routes.IvController.getLockedOut()),
        IvErrorStatus.UserAborted          -> (() => routes.IvController.getUserAborted()),
        IvErrorStatus.Timeout              -> (() => routes.IvController.getTimedOut()),
        IvErrorStatus.TechnicalIssue       -> (() => routes.IvController.getTechnicalIssue()),
        IvErrorStatus.PreconditionFailed   -> (() => routes.IvController.getPreconditionFailed()),
        IvErrorStatus.Unknown("")          -> (() => routes.IvController.getTechnicalIssue())
    ...
    "handling requests to see the failed matching page" must {
      ...
      "display the page" in {
        ...
        contentAsString(result) should include(message("iv.failedMatching.title"))
      }
    ...
    "handling requests to see the failed iv page" must {
      ...
      "display the page" in {
        ...
        status(result) shouldBe OK
        contentAsString(result) should include(message("iv.failedIv.title"))
      }
    ...
    "handling requests to see the insufficient evidence page" must {
      ...
      "display the page" in {
        ...
        status(result) shouldBe OK
        contentAsString(result) should include(message("iv.insufficientEvidence.title"))
      }
    ...
    "handling requests to see the locked out page" must {
      ...
      "display the page" in {
        ...
        status(result) shouldBe OK
        contentAsString(result) should include(message("iv.lockedOut.title"))
    ...
    "handling requests to see the user aborted page" must {
      ...
      "display the page" in {
        ...
        status(result) shouldBe OK
        contentAsString(result) should include(message("iv.userAborted.title"))
    ...
    "handling requests to see the timed out page" must {
      ...
      "display the page" in {
        ...
        status(result) shouldBe OK
        contentAsString(result) should include(message("iv.timeout.title"))
    ...
    "handling requests to see the technical issue page" must {
      ...
      "display the page" in {
        ...
        status(result) shouldBe OK
        contentAsString(result) should include(message("iv.technicalIssue.title"))
    ...
    "handling requests to see the precondition failed page" must {
      ...
      "display the page" in {
        ...
        status(result) shouldBe OK
        contentAsString(result) should include(message("iv.preconditionFailed.title"))
